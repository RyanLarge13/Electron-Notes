...
export const UserProvider = ({ children }: { children: ReactNode }): JSX.Element => {
  ...
  const sortConnections = (data) => {
    const { connections, connectionRequests, shareRequests, sharedNotes, userEmail } = data;
    ...
    const connectionRequestsReceived = [];
    ...
    const filteredShareRequestsFrom = [];
